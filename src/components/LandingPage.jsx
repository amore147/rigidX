      ...
      <header className="relative z-20 flex items-center justify-between w-full px-5 sm:px-8 md:px-14 py-4 sm:py-6">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 bg-[#ffedd5] text-[#1e293b] text-xs sm:text-sm font-semibold px-4 py-1.5 sm:py-2 rounded-full border border-orange-200/50 hover:bg-[#fed7aa] hover:scale-105 transition-all shadow-sm"
          >
            <svg
            ...
            <span className="text-amber-500 text-sm sm:text-base leading-none">
              ★
            </span>
            <span>Star</span>
          </a>
